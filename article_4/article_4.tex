...
\begin{figure}[htb]
	\centering
	\subfloat[ppc of $U_t$]{\includegraphics[width=.50\columnwidth]{early_r_ppc1_ut.png}\label{ppc_ut}}
...
\begin{figure}[htb]
	\centering
	\subfloat[ppc of $U_t$: underestimated $p_A$]{\includegraphics[width=.50\columnwidth]{early_contamination_under-ot.png}\label{under_ot}}
	\subfloat[ppc of $U_t$: overestimated $p_A$]{\includegraphics[width=.50\columnwidth]{early_contamination_over-ot}\label{over_ot}}
...
\begin{figure}[htb]
	\centering
	\subfloat[ppc of $U_t$: underestimated $p_A$]{\includegraphics[width=.50\columnwidth]{early_contamination_under-ut.png}\label{under_ut}}
 	\subfloat[ppc of $U_t$: overestimated $p_A$]{\includegraphics[width=.50\columnwidth]{early_contamination_over-ut}\label{over_ut}}
...
\begin{figure}[htb]
	\centering
	\subfloat[ppc of $x_A$: underestimated $p_A$]{\includegraphics[width=.50\columnwidth]{early_contamination_under-xa.png}\label{under_xa}}
	\subfloat[ppc of $x_A$: overestimated $p_A$]{\includegraphics[width=.50\columnwidth]{early_contamination_over-xa}\label{over_xa}}
